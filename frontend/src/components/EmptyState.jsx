...
export default function EmptyState({
  ...
  // Wrapper for action - Link if actionTo provided, button if onAction
  const ActionButton = () => {
  ...
  if (variant === "compact") {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        <div className="text-gray-600 mb-3">{iconElement}</div>
        <h3 className="text-gray-400 font-medium">{title}</h3>
        {description && (
          <p className="text-gray-500 text-sm mt-1 max-w-xs">{description}</p>
        )}
        {actionLabel && <div className="mt-4"><ActionButton /></div>}
      </div>
    );
  }
  ...
  if (variant === "inline") {
    return (
      <div className="flex items-center justify-center gap-4 py-6 text-gray-500">
        <div className="text-gray-600 w-8 h-8 [&>svg]:w-8 [&>svg]:h-8">{iconElement}</div>
        <div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <div className="text-gray-600 mb-4">{iconElement}</div>
