...
# Production Orders
router.include_router(production_orders.router, prefix="/production-orders", tags=["production"])

# Operation Status (nested under production orders)
router.include_router(operation_status.router, prefix="/production-orders", tags=["production-operations"])
...
router.include_router(po_documents.router, prefix="/purchase-orders", tags=["purchase-orders"])

# Low Stock Workflow (create POs from low stock)
router.include_router(low_stock.router, prefix="/purchase-orders", tags=["purchase-orders"])
...
router.include_router(resources.router, prefix="/resources", tags=["manufacturing"])

# Routings
router.include_router(routings.router, prefix="/routings", tags=["manufacturing"])
...
router.include_router(traceability.router, prefix="/traceability", tags=["quality"])

# Maintenance
router.include_router(maintenance.router, prefix="/maintenance", tags=["maintenance"])

# Command Center (dashboard)
router.include_router(command_center.router, prefix="/command-center", tags=["command-center"])
