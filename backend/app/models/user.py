...
class User(Base):
    ...
    def __repr__(self):
        """
        Return a concise developer-focused representation of the user including id, email, and status.
        
        Returns:
            str: Formatted string like "<User(id=1, email='user@example.com', status='active')>".
        """
