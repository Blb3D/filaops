...
class TestPurchaseOrderUOMConversion:
    ...
    def test_kg_to_g_conversion_exact_bug_scenario(self, db_session: Session):
        ...
        try:
            ...
            assert cost_per_g == Decimal("0.02"), f"Expected $0.02/G, got ${cost_per_g}/G"
        except Exception:
    ...
    def test_g_to_kg_conversion(self, db_session: Session):
        ...
        converted_qty, success = convert_quantity_safe(db_session, Decimal("1000"), "G", "KG")
        ...
        try:
            ...
            assert cost_per_kg == Decimal("20"), f"Expected $20/KG, got ${cost_per_kg}/KG"
        except Exception:
            # Fallback calculation
    ...
    def test_same_unit_no_conversion(self, db_session: Session):
        ...
        product = Product(sku="TEST-ITEM", name="Test Item", unit="EA", item_type="component", active=True)
        db_session.add(product)
        db_session.flush()

        # Test conversion: EA -> EA (should return same)
        converted_qty, success = convert_quantity_safe(db_session, Decimal("10"), "EA", "EA")
    ...
    def test_incompatible_units_fails(self, db_session: Session):
        ...
        converted_qty, success = convert_quantity_safe(db_session, Decimal("100"), "G", "EA")
