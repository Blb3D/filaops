...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_customer_traceability_profiles_id"), "customer_traceability_profiles", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_customer_traceability_profiles_user_id"), "customer_traceability_profiles", ["user_id"], unique=True
    )
    op.create_table(
        "machines",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_password_reset_requests_approval_token"), "password_reset_requests", ["approval_token"], unique=True
    )
    ...
    op.create_index(
        "ix_material_inventory_lookup", "material_inventory", ["material_type_id", "color_id"], unique=False
    )
    op.create_index(
        op.f("ix_material_inventory_material_type_id"), "material_inventory", ["material_type_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_production_orders_parent_order_id"), "production_orders", ["parent_order_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_production_order_operations_status"), "production_order_operations", ["status"], unique=False
    )
    op.create_table(
        "serial_numbers",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_serial_numbers_production_order_id"), "serial_numbers", ["production_order_id"], unique=False
    )
    ...
    op.create_index(
        ...
        "production_lot_consumptions",
        ["material_lot_id", "production_order_id"],
        unique=False,
    )
    op.create_index(op.f("ix_production_lot_consumptions_id"), "production_lot_consumptions", ["id"], unique=False)
    op.create_index(
        op.f("ix_production_lot_consumptions_material_lot_id"),
        "production_lot_consumptions",
        ["material_lot_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_production_lot_consumptions_production_order_id"),
        "production_lot_consumptions",
        ["production_order_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_production_lot_consumptions_serial_number_id"),
        "production_lot_consumptions",
        ["serial_number_id"],
        unique=False,
    )
