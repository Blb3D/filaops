...
def upgrade():
    ...
    if result:
        ...
        conn.execute(text("UPDATE production_order_operations SET resource_id = NULL WHERE resource_id IN (SELECT id FROM machines)"))
