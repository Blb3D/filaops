...
def upgrade() -> None:
    ...
    op.add_column(
        "company_settings",
        sa.Column("ai_ollama_url", sa.String(length=255), nullable=True, server_default="http://localhost:11434"),
    )
    op.add_column(
        "company_settings",
        sa.Column("ai_ollama_model", sa.String(length=100), nullable=True, server_default="llama3.2"),
    )
    op.add_column(
        "company_settings", sa.Column("external_ai_blocked", sa.Boolean(), nullable=False, server_default="false")
    )
