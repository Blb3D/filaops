...
def upgrade():
    ...
    op.add_column(
        "sales_orders", sa.Column("fulfillment_status", sa.String(50), nullable=False, server_default="pending")
    )
    ...
    try:
        op.add_column(
            "production_orders", sa.Column("qc_status", sa.String(50), nullable=False, server_default="not_required")
        )
    except Exception:
    ...
    try:
        op.add_column("production_orders", sa.Column("qc_notes", sa.Text(), nullable=True))
    except Exception:
        pass

    try:
        op.add_column("production_orders", sa.Column("qc_inspected_by", sa.String(100), nullable=True))
    except Exception:
        pass

    try:
        op.add_column("production_orders", sa.Column("qc_inspected_at", sa.DateTime(), nullable=True))
    except Exception:
        pass
