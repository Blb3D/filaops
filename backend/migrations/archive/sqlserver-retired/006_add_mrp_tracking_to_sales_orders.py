...
def upgrade() -> None:
    ...
    if "mrp_status" not in sales_orders_columns:
        op.add_column("sales_orders", sa.Column("mrp_status", sa.String(length=50), nullable=True))
    ...
    if "mrp_run_id" not in sales_orders_columns:
        op.add_column("sales_orders", sa.Column("mrp_run_id", sa.Integer(), nullable=True))
